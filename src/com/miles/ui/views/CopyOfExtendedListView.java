...
public class CopyOfExtendedListView extends ListView implements OnScrollListener {

    public static interface OnPositionChangedListener {

        public void onPositionChanged(CopyOfExtendedListView listView, int position, View scrollBarPanel);
    ...
    public CopyOfExtendedListView(Context context) {
        this(context, null);
    }

    public CopyOfExtendedListView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.listViewStyle);
    }

    public CopyOfExtendedListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected boolean awakenScrollBars(int startDelay, boolean invalidate) {
        ...
        System.out.println("awakenScrollBars==============startDelay=" + startDelay);
