...
import com.bookworm.utls.StorageManager;
		...
		OnTouchListener, OnItemClickListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		intent = getIntent();
		book = (BookBean) intent
				.getParcelableExtra(BookBean.class.getName());
		if (book == null) {
			finish();
		}
		String bookName = book.getmTitle();
		...
		type = getIntent().getIntExtra("type", Const.TYPE_POST_WEIBO);
		title = getIntent().getStringExtra("title");
		text = getIntent().getStringExtra("text");
		viewSetting();
		
		weiboContent.setText("#"+bookName+"#");
