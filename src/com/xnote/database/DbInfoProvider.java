...
public class DbInfoProvider extends ContentProvider {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			String sql_noteitems = "CREATE TABLE " + TABLE_NOTEITEMS + " ("
					...
					+ " INTEGER" + ");";
			MyLog.w(XNoteMainActivity.TAG, "创建表 " + TABLE_NOTEITEMS + " 的SQL语句："
					+ sql_noteitems);
			// 创建表appwidgetitems
			String sql_appwidgetitems = "CREATE TABLE " + TABLE_APPWIDGETITEMS
					...
					+ NoteItems.BACKGROUND_COLOR + " INTEGER" + ");";
			MyLog.w(XNoteMainActivity.TAG, "创建表 " + TABLE_APPWIDGETITEMS
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			MyLog.w(XNoteMainActivity.TAG, "Upgrading database from version "
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case NOTEITEMS:// Uri匹配到NoteItems表
			...
			if (id > 0) {
				...
				MyLog.d(XNoteMainActivity.TAG, "ContentProvider==>insert()");
				return tmpUri;
			}
			break;
		case APPWIDGETITEMS:
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		MyLog.d(XNoteMainActivity.TAG, "ContentProvider==>delete()");
		return count;
	}
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		getContext().getContentResolver().notifyChange(uri, null);
		MyLog.d(XNoteMainActivity.TAG, "ContentProvider==>update()");
		return count;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		MyLog.d(XNoteMainActivity.TAG, "ContentProvider==>query()");
		return c;
	}
