...
public class WriteXml {
	...
	public boolean writeXml() throws Exception {
		...
		if (Environment.getExternalStorageState().equals(
			...
			if (!dir.exists()) {
				dir.mkdir();
				MyLog.d(XNoteMainActivity.TAG, "WriteXml==>" + dir
			...
			MyLog.d(XNoteMainActivity.TAG, "WriteXml==>can not access SDCard");
			return false;
		}
	}
	...
	private boolean writeNote(FileWriter nwriter) throws Exception {
		MyLog.d(XNoteMainActivity.TAG, "WriteXml==>begin to write XML...");
